"""bootstrap the 25 tables missing from older database volumes

Revision ID: 20260917_0005
Revises: 20260916_0004
Create Date: 2026-09-17

Mirrors database/migrations/006_bootstrap_missing_tables.sql. Purely additive:
...
def downgrade() -> None:
    # Intentionally a no-op: this migration only creates tables that were
    # absent, and dropping them would destroy rows written since. Reverting
    # it would also put the database back into a 500-ing state.
    pass
